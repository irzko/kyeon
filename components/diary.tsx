      ...
      <div className="relative px-2 py-2 bg-[#F7F2FA] rounded-2xl">
        <div className="flex justify-between">
          <div className="flex items-center">
            <time className="mb-1 text-sm leading-none h-full font-bold text-[#1D192B] bg-[#E8DEF8] rounded-full px-2 flex items-center">
              {new Date(diary.datetime).toLocaleString()}
            </time>
            <p className="text-base font-bold ml-2 italic text-gray-500">
              {diary.felling}
            </p>
          </div>
