...
const DiaryCard = ({ diary }: { diary: IDiary }) => {
  ...
  return (
    <li className="mb-4 ml-4">
      ...
      <div className="flex flex-col bg-white transition duration-300 hover:ease-in-out rounded-2xl border border-gray-100 hover:border-white dark:border-gray-800 dark:hover:border-gray-700 hover:shadow-lg dark:hover:shadow-lg-light dark:bg-gray-900">
