        ...
        <Navbar position="bottom">
          ...
          <NavbarContent className="w-full justify-evenly">
            ...
            <NavbarItem>
              <Link href="/search">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={28} height={28} color={"#ffffff"} fill={"none"}>
                  <path d="M17.5 17.5L22 22" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
                  <path d="M20 11C20 6.02944 15.9706 2 11 2C6.02944 2 2 6.02944 2 11C2 15.9706 6.02944 20 11 20C15.9706 20 20 15.9706 20 11Z" stroke="currentColor" strokeWidth="2.5" strokeLinejoin="round" />
                </svg>
              </Link>
            </NavbarItem>
            <NavbarItem>
